  ...
  const services = [
    {
      ...
      icon: <FaChartLine className="text-accent-DEFAULT w-6 h-6" />,
    },
    {
      id: 2,
      ...
      icon: <FaShieldAlt className="text-accent-DEFAULT w-6 h-6" />,
    },
    {
      id: 3,
      ...
      icon: <FaCreditCard className="text-accent-DEFAULT w-6 h-6" />,
    },
    {
      id: 4,
      ...
      icon: <FaExchangeAlt className="text-accent-DEFAULT w-6 h-6" />,
    },
    {
      id: 5,
      ...
      icon: <FaPiggyBank className="text-accent-DEFAULT w-6 h-6" />,
    },
    {
      id: 6,
      ...
      icon: <FaRegBell className="text-accent-DEFAULT w-6 h-6" />,
    },
  ];
};
